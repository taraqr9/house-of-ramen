                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   class="form-control"
                                                   placeholder="Search permissions by group or action (e.g. employee, view, pme dashboard)...">
                                        </div>
                                    ...
                                    <div class="row">
                                        @foreach($groupedPermissions as $sectionName => $sectionPermissions)
                                            <div class="col-12 mb-3 permission-group"
                                                 data-search="{{ strtolower(str_replace('_', ' ', $sectionName)) }} {{ strtolower($sectionPermissions->pluck('name')->implode(' ')) }}">
        ...
        $(document).ready(function () {
            ...
            $('#permission_search').on('keyup', function () {
                ...
                $('.permission-group').each(function () {
                    let matches = term === '' || $(this).data('search').toString().indexOf(term) !== -1;
