                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="parent_brand_id" class="form-control select2 @error('parent_brand_id') is-invalid @enderror">
                                                ...
                                                @foreach($parentBrands as $parent)
                                                    <option value="{{ $parent->id }}" @selected(old('parent_brand_id', $brand->parent_brand_id) == $parent->id)>{{ $parent->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="isActive" @checked(old('is_active', $brand->is_active) == 1)>
