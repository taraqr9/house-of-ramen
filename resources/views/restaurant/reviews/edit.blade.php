                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <h5 class="card-title mb-1">Edit Review</h5>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <form action="{{ route('restaurant-reviews.update', $review->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="rating" class="form-control select2 @error('rating') is-invalid @enderror" required>
                                                @for ($i = 5; $i >= 1; $i--)
                                                    <option value="{{ $i }}" @selected((int) old('rating', $review->rating) === $i)>{{ $i }} Star{{ $i > 1 ? 's' : '' }}</option>
                                                @endfor
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="reviewed_at" value="{{ old('reviewed_at', $review->reviewed_at?->format('Y-m-d')) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="review_text" rows="5"
                                                      class="form-control @error('review_text') is-invalid @enderror" required>{{ old('review_text', $review->review_text) }}</textarea>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="display_order" value="{{ old('display_order', $review->display_order) }}" min="0"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="isActive" @checked(old('is_active', $review->is_active) == 1)>
