    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            @include('partials.breadcrumb', [
                'items' => [['label' => 'Stores', 'url' => route('phone-stores.index')], ['label' => 'Add']],
            ])
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-sm-6"><h5 class="card-title mb-1">Add Store</h5></div>
                                <div class="col-sm-6">
                            ...
                            <form action="{{ route('phone-stores.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Name <span class="text-danger">*</span></label>
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Star Tech">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="website_url" value="{{ old('website_url') }}" class="form-control @error('website_url') is-invalid @enderror" placeholder="https://...">
